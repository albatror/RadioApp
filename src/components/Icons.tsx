...
export const IconFB = (p: any) => <Icon {...p} d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" fill="currentColor" />;
export const IconIG = (p: any) => <Icon {...p} d={["M3 7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v10a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V7z", "M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0", "M17.5 6.5h.01"]} />;
export const IconYT = (p: any) => <Icon {...p} d="M22 8.6a3 3 0 0 0-2.1-2.1C18 6 12 6 12 6s-6 0-7.9.5A3 3 0 0 0 2 8.6 31 31 0 0 0 1.5 12a31 31 0 0 0 .5 3.4 3 3 0 0 0 2.1 2.1C6 18 12 18 12 18s6 0 7.9-.5a3 3 0 0 0 2.1-2.1 31 31 0 0 0 .5-3.4 31 31 0 0 0-.5-3.4z M10 15.5l5-3.5-5-3.5v7z" fill="currentColor" />;
